...
>>>>>>> bd57489a4864f5812aab3358400ce1846e9e3cdd
            ...
            <div>
            <button className="mt-4 text-white" onClick={requestFullScreenAndLandscape}>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
          ...
          <div className="my-4 grid grid-cols-3 gap-x-1 w-full max-w-5xl md:mx-auto">
            <Link to={`/show/${prev}`} className={!prev && "disable-link"}>
              <button
                onClick={() => {
                  setIsLoading(true);
                }}
            ...
            <Link to={`/show/${next}`} className={!next && "disable-link"}>
              <button
                onClick={() => {
                  setIsLoading(true);
                }}
